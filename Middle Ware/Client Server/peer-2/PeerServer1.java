...
class PortListenerSend1 implements Runnable {		//Implementing Runnable Interface
	...
	public PortListenerSend1(int port) {
...
public class PeerServer1 {						//Client class - named as Peer Server1
	...
	public PeerServer1() {						//constructor

		System.out.println("Welcome to Peer 2 (Peer ID: 1002) Execution");
	...
	{		
		PeerServer1 peerserver1Frame = new PeerServer1();			//New object Declaration
	}
	...
	{
		Thread dthread = new Thread (new PortListenerSend1(peerid));
